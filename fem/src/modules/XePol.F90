...
!------------------------------------------------------------------------------
   SUBROUTINE XePol( Model,Solver,Timestep,TransientSimulation )
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
     ...
     LOGICAL :: Stabilize = .FALSE., Bubbles, GotIt, AbsoluteMass = .TRUE.
...
!------------------------------------------------------------------------------
     ...
     CALL Info( 'XePol', ' ', Level=4 )
     CALL Info( 'XePol', &
         '-------------------------------------', Level=4 )
     CALL Info( 'XePol', 'Solving for species transport', Level=4 )
     CALL Info( 'XePol', &
         '-------------------------------------', Level=4 )
...
! Solve species weakly coupled, allocate accordingly
       ...
       IF ( istat /= 0 ) THEN
         CALL Fatal( 'XePol', 'Memory allocation error.' )
       END IF
